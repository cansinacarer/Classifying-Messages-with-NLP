...
def index():
    ...
    category_counts = (categories.mean() * categories.shape[0]).sort_values(
        ascending=True
    )
    ...
    graphs = [
        {
            ...
            "layout": {
                "title": "Number of Messages by Genres",
                "yaxis": {"title": "Count"},
                "xaxis": {"title": "Genre"},
            },
        },
        {
            "data": [Bar(x=category_counts, y=category_names, orientation="h")],
            "layout": {
                "title": "Number of Messages by Categories",
                "yaxis": {"title": "Count"},
